...
from products.synspective.synspective_sm_grd_product import SynspectiveSMGRDProduct
from products.synspective.synspective_sm_sr_grd_product import SynspectiveSMSRGRDProduct
...
class SynspectiveHandler(ProductHandler):
    ...
    def extract_type_and_mode(self, product_path):
        """Extract product type and mode from the XML metadata."""
